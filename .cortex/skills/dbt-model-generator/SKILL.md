...
- `coc-finance-demo`: dbt project name (default: derived from database name)
- `/Users/saurabh.bw.kumar/Desktop/CoCo/git-repos/coco-demo`: Where to create the project on disk (default: `~/Documents/coco-dev/<PROJECT_NAME>`)
- `https://github.com/saurabhkr0/coco-demo.git`: GitHub repo for PR (format: `owner/repo-name`)
- `COMPUTE_WH`: Snowflake warehouse (default: `COMPUTE_WH`)
